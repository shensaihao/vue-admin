<template>
  <div>
    <el-table v-loading="loading" :data="data" style="width: 100%" :header-cell-style="headClass">
      ...
      <el-table-column prop="contractHash" width="150px" label="商票上链哈希" align="center" class-name="draft_list_bg">
        <template slot-scope="scope">
          <el-button
            type="text"
      ...
      <el-table-column prop="acceptDate" label="票据到期日" align="center">
        <template slot-scope="scope">
          {{ getDate(scope.row.acceptDate) }}
        </template>
      </el-table-column>
      <el-table-column prop="passedTime" label="承兑日期" align="center" />
      ...
      <el-table-column prop="address" label="确认承兑人员" align="center" />
