    ...
    <el-card class="my-card">
      <el-row :gutter="20" class="m-b-20">
        <el-col :span="8" class="flex-start">
          <span class="ft-size-14 display-inline-b width-150">搜索申请编号</span>
          <el-input v-model="searchForm.discountId" placeholder="请输入" style="width:250px" size="small" class="m-l-10" />
        </el-col>
        <el-col :span="8">
          <span class="ft-size-14 display-inline-b width-150">搜索贴现申请人名称</span>
          <el-input v-model="searchForm.discountApplicantName" placeholder="请输入" style="width:250px" size="small" class="m-l-10" />
        </el-col>
        <el-col :span="8">
          <span class="ft-size-14 display-inline-b width-150">搜索贴现tokenid</span>
          <el-input v-model="searchForm.tokenId" placeholder="请输入" style="width:250px" size="small" class="m-l-10" />
        </el-col>
      </el-row>
      <el-row :gutter="20">
        <el-col :span="8">
          <span class="ft-size-14 display-inline-b width-150">搜索初始tokenid</span>
          <el-input v-model="searchForm.initialToken" placeholder="请输入" style="width:250px" size="small" class="m-l-10" />
        </el-col>
        <el-col :span="8" class="flex-start">
