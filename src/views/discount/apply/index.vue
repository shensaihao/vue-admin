  ...
  <div>
    <el-card class="my-card">
      ...
      <el-row :gutter="20">
        ...
        <el-col :span="7" class="flex-start">
          <el-button class="m-b-20" type="primary" size="small" style="width: 30%" @click="searchList">搜索</el-button>
          <el-button class="m-b-20 m-l-10" style="width: 30%" size="small" @click="resetList">重置</el-button>
        </el-col>
      </el-row>
    </el-card>
    <el-card class="my-card">
